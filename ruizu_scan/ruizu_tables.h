/* Ruizu MJPEG quant / Huffman tables (from official.avi / ruizu_jpeg.py). */
#ifndef RUIZU_TABLES_H
#define RUIZU_TABLES_H

#include <stdint.h>

static const uint8_t ruizu_luma_quant[64] = {
...
static const uint8_t ruizu_chroma_quant[64] = {
